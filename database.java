...
public class database extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Ttable.setBackground(new java.awt.Color(255, 255, 204));
        ...
        Ttable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "to", "from", "date", "agency", "classes", "name", "age", "gender", "mobile", "email"
            }
        ) {
    ...
    public void Connect() {
        try {
           ...
           String  tbData[]={to,from,date,agency,classes,name,age,gender,mobile,email};
           ...
           con.close();
            ...
            Logger.getLogger(hlo1.class.getName()).log(Level.SEVERE, null, ex);
        }
